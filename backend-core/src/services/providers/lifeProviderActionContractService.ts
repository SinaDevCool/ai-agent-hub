...
const specs: Record<string, Spec> = {
  ...
  "appointments.booking.manage": { required: ["operation", "providerId", "approvalRequestId"], fields: { operation: t("book, reschedule, cancel."), providerId: t("Provider."), slotId: t("Live slot."), ...approval }, prompt: "Choose and approve appointment change." },
