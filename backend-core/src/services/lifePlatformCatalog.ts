...
export const lifeProviders: LifeProvider[] = [
  ...
  provider({ id: "amadeus", label: "Amadeus", domains: ["travel"], capabilities: ["travel.flight.search", "travel.flight.book", "travel.hotel.search", "travel.ground.search"], regions: ["GLOBAL"], executionLevels: ["discover", "compare", "prepare", "transact"], auth: "api_key", access: "partner_approval", officialDocs: "https://developers.amadeus.com/self-service/apis-docs", notes: "Ticket issuance requires a production commercial arrangement or consolidator." }),
