ALTER TABLE "workflow_connections" ADD COLUMN "capability_key" TEXT NOT NULL DEFAULT 'general.research';
ALTER TABLE "workflow_connections" ADD COLUMN "description" TEXT NOT NULL DEFAULT '';
